...
gitlab_rails['gitlab_email_from'] = 'noreply@sighup.io'
gitlab_rails['gitlab_email_display_name'] = '{{ display_name }} - CI Notification'
gitlab_rails['gitlab_email_reply_to'] = 'noreply@sighup.io'
# gitlab_rails['gitlab_email_subject_suffix'] = 'SIGHUP CI'
...
registry['health_storagedriver_enabled'] = false # This is because of a bug with the s3 storage driver: https://forum.gitlab.com/t/docker-registry-not-available/8049
...
registry['storage'] = {
  's3' => {
    ...
    'region' => 'us-east-1',
    'regionendpoint' => 'https://s3.wasabisys.com'
  }
}
...
letsencrypt['auto_renew_minute'] = 1 # Should be a number or cron expression, if specified.
